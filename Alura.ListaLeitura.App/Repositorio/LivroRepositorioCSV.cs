...
namespace Alura.ListaLeitura.App.Repositorio
{
    ...
    {
        private static readonly string nomeArquivoCSV = @"C:\Users\AS-Informatica\Documents\cursos\backend\Asp.NET\pt1\Alura.ListaLeitura.App\Repositorio\livros.csv";
